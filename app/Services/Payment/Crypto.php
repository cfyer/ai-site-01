...
class Crypto {
    ...
    private false|CurlHandle $session;
...
//    const API_BASE = 'https://api.nowpayments.io/v1/';
	...
	private function Call($method, $endpoint, $data = []): bool|string
    {
		$ch = $this->session;
	...
	public function getCurrencies(): bool|string
    {
	...
	*    ]
	*/
	public function getEstimatePrice(array $params): bool|string
    {
	...
	*      'pay_currency'			=> (string) Required. The cryptocurrency in which the pay_amount is specified (btc, eth, etc)
	...
	*      'purchase_id'			=> (string) Optional. ID of purchase for which you want to create other payment, only used for several payments for one order
	*      'payout_address'			=> (string) Optional. Usually the funds will go to the address you specify in your Personal account
	*      'payout_currency'		=> (string) Optional. Currency of your external payout_address, required when payout_address is specified
	...
	*    ]
	*/
	public function createPayment(array $params): bool|string
    {
	...
	*/
	public function getPaymentStatus(int $paymentID): bool|string
    {
	...
	*    ]
	*/
	public function getMinimumPaymentAmount(array $params): bool|string
    {
	...
	*      'sortBy'			=> (string) sort the received list by a parameter. Set to created_at by default (possible values: payment_id, payment_status, pay_address, price_amount, price_currency, pay_amount, actually_paid, pay_currency, order_id, order_description, purchase_id, outcome_amount, outcome_currency)
	...
	*    ]
	*/
	public function getListPayments(array $params = []): bool|string
    {
	...
	*    ]
	*/
	public function createInvoice(array $params): bool|string
    {
